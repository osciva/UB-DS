...
public class EscenaPayPal extends Escena{
    public TextField correu_text;
    ...
    public void setActivitat(String activitat,String excursio){
        ...
        pagar_btn.setOnAction(new EventHandler<javafx.event.ActionEvent>(){
            ...
            public void handle(ActionEvent actionEvent) {
                if(!correu_text.getText().equals("cextrem@pagaments.com")){
                    alert.setAlertType(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
                    alert.setHeaderText("No és el nostre correu");
                    alert.show();
                    ...
                    controller.pagarPayPal(activitat,excursio,controller.recuperaString());
